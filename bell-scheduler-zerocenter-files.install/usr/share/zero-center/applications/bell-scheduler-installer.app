...
Name[ca@valencia]=Instal·lador del Bell Scheduler
...
Comment[ca@valencia]=Assistent d'instal·lació del Bell-Scheduler (aplicació per a programar les alarmes dels centres educatius per a l'entrada, eixida, recreo)
Icon=bell-scheduler
Category=Software
