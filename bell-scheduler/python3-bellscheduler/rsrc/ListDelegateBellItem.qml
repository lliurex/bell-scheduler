            ...
            Menu{
                ...
                MenuItem{
                    ...
                    onClicked:{
                        var bellToChanged={
                            "allBells":false,
                            "active":!bellActivated,
                            "bellId":bellId
                        };
                        bellsOptionsStackBridge.changeBellStatus(bellToChanged)
                    }
                }
                ...
                MenuItem{
                    ...
                    onClicked:{
                        var bellToEdit={
                            ...
                            "isSoundError":isSoundError
                        };
                        bellStackBridge.loadBell(bellToEdit)
                    }
                }
                ...
                MenuItem{
                    ...
                    onClicked:{
                        ...
                        bellStackBridge.duplicateBell(bellToDuplicate)
                    }
                }
                ...
                MenuItem{
                    ...
                    onClicked:{
                        ...
                        bellsOptionsStackBridge.removeBell(bellToDelete)
                    }
                }
            }
        }
